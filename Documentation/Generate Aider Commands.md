...
| `-Claude`         | `string`   | `Claude1`            | Claude account to use. Maps to `CLAUDE_CONFIG_DIR`: `Claude1` = `.claudemain`, `Claude2` = `.claudealt`. |
...
|-----------|-------------------------------------|
| `Claude1` | `$env:USERPROFILE\.claudemain`   |
| `Claude2` | `$env:USERPROFILE\.claudealt`|
